...
graphs=["it-2004", "sk-2005", "uk-2007-05", "webbase-2001"]
nrows = 1
ncols = 4
...
for i, axi in enumerate(ax.flat):
    ...
    axi.set_title(graphs[i], fontsize=32)
    if(i==0):
...
plt.tight_layout()
plt.savefig("time_per_iteration_easy_1.svg")
plt.savefig("time_per_iteration_easy_1.pdf")
plt.show()
'''
